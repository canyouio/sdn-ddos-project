...
import json
import ast
from ryu.base import app_manager # 确保导入 app_manager
...
class RestStatsApi(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dpset = kwargs.get('dpset') or app_manager.lookup_service_brick('dpset')
        self.wsgi = kwargs.get('wsgi') or app_manager.lookup_service_brick('wsgi') # <-- Changed here
        self.waiters = {}
        self.data = {}
        self.data['dpset'] = self.dpset
        self.data['waiters'] = self.waiters
        mapper = self.wsgi.mapper # Use self.wsgi here

        self.wsgi.registory['StatsController'] = self.data # Use self.wsgi here
        path = '/stats'
        uri = path + '/switches'
